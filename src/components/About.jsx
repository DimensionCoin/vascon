...
import ConstructionImage from "../assets/hero.png"; // Replace with the path to your image
import "./about.css"
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg- text-gray-200 p-4">
